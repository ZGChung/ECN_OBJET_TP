...
public class Joueur<T extends Personnage> {
    ...
    public Joueur(String nomJoueur, String nom, int ptV, int ptM, int pA, int pP, 
            int pM, int rM, int dA, int dM, int distMax,int ptP, Point2D pos, 
            Class<T> type, List<Personnage> list){
        super();
        this.nomJoueur = nomJoueur;
        this.perso = new Personnage(nom, ptV, ptM, pA, pP, pM, rM, dA, dM, 
        distMax, ptP, pos);
