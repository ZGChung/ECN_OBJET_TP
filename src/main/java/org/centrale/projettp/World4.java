...
/**
 * class du monde, où les personnages et les monstres interagissent pour tester
 * le fonctionnement de le hashMap
 * 
 * @author zgchung uble
 */
public class World4 {
    ...
    public World4(int nbArcher, int nbPaysan, int nbLapin, int nbGuerrier, int nbMage, int nbLoup, int nbPotion,
            int mondeLongueur, int mondeLargeur, int nbJoueur) {
